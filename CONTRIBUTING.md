...
- Post in [GitHub Discussions](https://github.com/genixbit/agency-agents/discussions)
...
Want agency-agents to install into a new tool (a CLI, editor, or agent runtime)? First, **[open a Discussion](https://github.com/genixbit/agency-agents/discussions)** — new integration platforms are a "discuss first" change (see the PR Process below). Once there's alignment, a clean integration is small — usually **~5 files, never the converted output itself.** The just-merged Mistral Vibe integration is a good worked example to copy.
...
We love ambitious ideas — a [Discussion](https://github.com/genixbit/agency-agents/discussions) just gives the community a chance to align on approach before code gets written. It saves everyone time, especially yours.
...
- **General Questions**: [GitHub Discussions](https://github.com/genixbit/agency-agents/discussions)
- **Bug Reports**: [GitHub Issues](https://github.com/genixbit/agency-agents/issues)
- **Feature Requests**: [GitHub Issues](https://github.com/genixbit/agency-agents/issues)
- **Community Chat**: [Join our discussions](https://github.com/genixbit/agency-agents/discussions)
...
Your contributions make Genixbit Agents better for everyone. Whether you're:
...
[Open an Issue](https://github.com/genixbit/agency-agents/issues) • [Start a Discussion](https://github.com/genixbit/agency-agents/discussions) • [Submit a PR](https://github.com/genixbit/agency-agents/pulls)
