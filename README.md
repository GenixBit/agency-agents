# 🎭 Genixbit Agents: AI Specialists Ready to Transform Your Workflow
...
Born from a Reddit thread and months of iteration, **Genixbit Agents** is a growing collection of meticulously crafted AI agent personalities. Each agent is:
...
| 📈 [Behavioral Economist & Choice Architect](specialized/behavioral-economist.md) | Choice architecture, nudge theory, decision design | Ethical conversion, decoy/anchor pricing, user heuristics |
| 🤝 [Negotiation & Conflict Mediator](specialized/conflict-resolution-mediator.md) | Mediation & interest-based negotiation | Dispute resolution, active listening, de-escalation, trust repair |
...
### ⚖️ Legal Operations Division

Legal counsel, contract review, and corporate compliance specialists.

| Agent | Specialty | When to Use |
|-------|-----------|-------------|
| ⚖️ [Corporate Counsel & Compliance Specialist](legal-ops/legal-ops-corporate-counsel.md) | Startup corporate governance, legal risk mapping, IP filing strategy | Entity structuring, board resolutions, regulatory audits, and founder agreements |
| 🖋️ [Contract Negotiation Specialist](legal-ops/legal-ops-contract-negotiator.md) | Drafting, reviewing, and redlining commercial agreements | NDAs, MSAs, SLAs, SaaS service agreements, liability caps, and indemnity negotiations |
...
Have you used these agents successfully? Share your story in the [Discussions](https://github.com/genixbit/agency-agents/discussions)!
...
```
  ...
  [ ]  6)  [ ]  OpenClaw        (~/.openclaw/genixbit-agents)
...
- **GitHub Discussions**: [Share your success stories](https://github.com/genixbit/agency-agents/discussions)
- **Issues**: [Report bugs or request features](https://github.com/genixbit/agency-agents/issues)
- **Reddit**: Join the conversation on r/ClaudeAI
- **Twitter/X**: Share with #GenixbitAgents
...
**🎭 Genixbit Agents: Your AI Dream Team Awaits 🎭**

[⭐ Star this repo](https://github.com/genixbit/agency-agents) • [🍴 Fork it](https://github.com/genixbit/agency-agents/fork) • [🐛 Report an issue](https://github.com/genixbit/agency-agents/issues)
