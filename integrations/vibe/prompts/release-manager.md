...
Expert in automated release engineering, semantic versioning, git tagging, GitHub release publishing, changelog generation, and automated validation for agent rosters and software packages.
